...
class Edit():
    ...
    def paste(self, *args):
        self.text.insert(SEL_FIRST, SEL_LAST)
...
def main(root, text, menubar):
    ...
    # escape key deselects text
    root.bind_all("<Escape>", lambda event: objEdit.text.tag_remove(SEL, "1.0", END))
...
if __name__ == "_main_":
    print("This is a module for other programs.")
